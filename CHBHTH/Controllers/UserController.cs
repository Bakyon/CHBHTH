...
namespace CHBHTH.Controllers
{
    public class UserController : Controller
    {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (check == null)
                    {
                        ...
                        ViewBag.RegOk = "Registration is successful!";
                        ViewBag.isReg = true;
                        // Thêm người dùng  mới
                    ...
                    {
                        ViewBag.RegOk = "Email already existed! Please use another email.";
                        return View("Dangky");
                    }
        ...
        public ActionResult Dangnhap(FormCollection userlog)
        {
            ...
            var acc = db.TaiKhoans.SingleOrDefault(x => x.Email.Equals(userMail));
            var role = acc.IDQuyen;
            ...
            {
                ViewBag.Fail = "Account email or password is not correct!";
